...
//{
//    public class MinimalDAWGSearcherAlternate
//    {
//        private MinimalDAG<char> _dawg;

//        public MinimalDAWGSearcherAlternate(MinimalDAG<char> dawg)
//        {
//            _dawg = dawg;
//        }
//        /// <summary>
...
//        /// <param name="index"></param>
//        /// <returns></returns>
//        private IEnumerable<DAGSearchResult<char>> FindValidSequencesContainingIndex(List<char> valuePool, int index, Pattern<char> pattern, int wildCardCount = 0)
//        {
...
//            //valid ends are on an index
//            int min = 0;
//            var ValidEnds = new  HashSet<int>();

//            bool endFound = false;
//            foreach (int i in Enumerable.Range(index, pattern.SearchSpace.Length - (index + 1)))
//            {
//                if (!endFound)
//                {
//                    if (pattern.SearchSpace[i] != null && !pattern.IsIndexForcedEmpty(i))
//                    {

//                        //check if full end
//                        if (i + 1 == pattern.SearchSpace.Length || pattern.IsIndexPotentiallyEmpty(i + 1))
//                        {
//                            endFound = true;
//                            ValidEnds.Add(i);
//                        }
...
//                else
//                {
//                    if (pattern.SearchSpace[i] == null && pattern.IsIndexPotentiallyEmpty(i))
//                    {
//                        endFound = true;
//                        //check if full end
//                        if (i + 1 == pattern.SearchSpace.Length || pattern.IsIndexPotentiallyEmpty(i + 1))
...
//            //            {
//            //                if(j == pattern.SearchSpace.Length-1 || pattern.SearchSpace[j+1] == null || pattern.IsIndexForcedEmpty(j+1))
//            //                    ValidEnds[i].Add(j-);
//            //            }
...
//            //    }
//            //}
//            return FindMatches(StartingPoints, ValidEnds,/*PrefixBoundaries, SuffixBoundaries,*/ pattern);
//        }
...
//                //    }
//                //}
//                var Words = SequenceSearch(startingState, _dawg.GetChildren, endPoints, 1, pattern);
//                foreach(var word in Words)
//                {
//                    var Sequence = BuildSequence(word.UsedValues, index, pattern);
//                    yield return new DAGSearchResult<char>(Sequence, word.WildCardIndices, index, word.UsedValues);
//                }
//            }
//        }
//        /// <summary>
...
//            var StartingIndices = PrimitiveStartingPoints(valuePool, pattern, wildCardCount);
...
//                    if (j < pattern.SearchSpace.Length)
//                    {
//                        if (j == 0 || pattern.SearchSpace[j - 1] == null || pattern.IsIndexForcedEmpty(j - 1))
//                        {
//                            if (pattern.SearchSpace[j] != null && !pattern.IsIndexForcedEmpty(j))
//                            {
//                                if (wildCardCount > 0)
